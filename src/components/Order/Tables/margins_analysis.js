...
export default TableMargins = ({ document }) => {
    ...
    return (
        <Table borderStyle={{ borderWidth: 1, borderColor: Color.soft }} style={{ marginBottom: 10 }}>
            <Row data={['', 'MC 2019', 'MC 2018H', '%', 'MC 2018T', '%', 'Objetivo', '%']} style={{ height: 20, backgroundColor: Color.primary }} textStyle={{ fontWeight: 'bold', fontSize: 11, textAlign: 'center', color: '#fff' }} />
